        ...
        $callback! {
            ...
            orchestration => {
                ...
                owners: [
                    ...
                    "orchestration::rotation::accounts",
            ...
            providers => {
                ...
                owners: [
                    ...
                    "providers::catalog::config_seed",
                    "providers::catalog::credential_health",
                    ...
                    "providers::catalog::profile_identity",
                    "providers::catalog::profile_paths",
                    "providers::catalog::profiles",
                    "providers::catalog::ranking",
                    "providers::catalog::selectors",
                    "providers::catalog::entry",
