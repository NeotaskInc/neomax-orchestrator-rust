# Neomax command and environment reference

This document contains the complete Neomax command, runtime, configuration,
and distribution reference. Start with the repository [README](../README.md)
for installation and common workflows.
